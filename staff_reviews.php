...
// Fetch reviews for the logged-in user only
$sql = "SELECT * FROM reviews WHERE staffName = '$username' AND star_rating >= 3 ORDER BY created_at DESC";
