...
if ($user_id && isset($conn) && $conn instanceof mysqli) {
    $sql_unread_count = "SELECT COUNT(*) as unread_count FROM notifications WHERE patient_id = ? AND read_status = 'unread'";
...
if ($user_id && isset($conn) && $conn instanceof mysqli) {
    ...
    $sql_notifications = "SELECT id, message, status, read_status, created_at FROM notifications WHERE patient_id = ? ORDER BY created_at DESC";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['id'])) {
    ...
    if ($user_id && isset($conn) && $conn instanceof mysqli && $notification_id) {
        $sql_update = "UPDATE notifications SET read_status = 'read' WHERE id = ? AND patient_id = ?";
                ...
                <ul>
                    ...
                    <li class="dropdown">
                        ...
                        <div class="dropdown-content">
                            <a href="submit_booking.php">Book Now</a>
                            <a href="booking.php">View Appointments</a>
                        </div>
                    </li>
                    <li class="dropdown">
                        <a href="javascript:void(0)" class="dropbtn">Treatment</a>
                        <div class="dropdown-content">
                            <a href="treatmentpatient.php">Add Video</a>
                            <a href="patientviewtreatment.php">View Treatment</a>
                        </div>
                    </li>
                    <li><a href="health_questionnaire.php">Health Questionnaire</a></li>
                    <li class="dropdown">
                        <a href="javascript:void(0)" class="dropbtn">Reviews</a>
                        <div class="dropdown-content">
                            <a href="add_review.php">Give Reviews</a>
